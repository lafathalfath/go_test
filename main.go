...
func main() {
	...
	r := mux.NewRouter()
    r.HandleFunc("/products", apiConfig.handleGetAllProducts).Methods("GET")
    r.HandleFunc("/products", apiConfig.handleCreateProduct).Methods("POST")
    r.HandleFunc("/products/{id}", apiConfig.handleUpdateProduct).Methods("PUT")
    r.HandleFunc("/products/{id}", apiConfig.handleDeleteProduct).Methods("DELETE")
    
	log.Println("server is running on port: 8080")
	http.ListenAndServe(":8080", r)
}

func (apiConfig *ApiConfig) handleGetAllProducts(w http.ResponseWriter, r *http.Request) {
...
func (apiConfig *ApiConfig) handleCreateProduct(w http.ResponseWriter, r *http.Request) {
...
func (apiConfig *ApiConfig) handleUpdateProduct(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
...
func (apiConfig *ApiConfig) handleDeleteProduct(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	id := vars["id"]
